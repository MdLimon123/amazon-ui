           ...
           child: Row(
             children: const [
               ...
               Padding(
                 ...
                 child: Text(
                   'Delivery to Prodip Pal - Thakurgaon -5100',
               ...
               Padding(
                 ...
                 child: Icon(
                   Ionicons.chevron_down_outline,size: 18.0,),
               ),
             ],
           ),
          ),
                        ...
                        Column(
                          children: [
                            Container(
                              ...
                              padding: const EdgeInsets.only(left: 10.0),
                              child: Text(
                                itemsList[index].title,overflow: TextOverflow.ellipsis,
                                maxLines: 3,
                            ...
                            Container(
                              ...
                              child: Text(
                                '₹${itemsList[index].price}',overflow: TextOverflow.ellipsis,
                            ...
                            Container(
                              ...
                              child: const Text(
                                'Eligible for FREE Shipping',overflow: TextOverflow.ellipsis,
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  const Text(
                                    'Size',overflow: TextOverflow.ellipsis,
                                    style: TextStyle(
                                      fontWeight: FontWeight.w600,
                                      fontSize: 13.0
                                    ),
                            ...
                            children: [
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  height: 32.0,
                                  alignment: Alignment.center,
                                  child: const Icon(FeatherIcons.minus, size: 18.0,),
                                ),
                              ),
                              DecoratedBox(
                                  decoration: BoxDecoration(
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  height: 32.0,
                                  alignment: Alignment.center,
                                  child: const Icon(FeatherIcons.plus, size: 18.0,),
                                ),
                              ),
                            ],
                          ),
