...
class _HomePageState extends State<HomePage> {
      ...
      child: Row(
        children: const [
          ...
          Padding(
            ...
            child: Text(
              'Deliver to Fanna - Thakurgaon 5100',
              style: TextStyle(fontWeight: FontWeight.w500),
            ),
          ),
          Padding(
            padding: EdgeInsets.only(left: 05.0, top: 2.0),
            child: Icon(
  ...
  Widget imageSlider() {
    return CarouselSlider(
        ...
        options: CarouselOptions(viewportFraction: 1.0, height: 200));
  }
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    margin: const EdgeInsets.only(
                        left: 0.0, right: 5.0, top: 5.0, bottom: 3.0),
                    child: Column(
                      children: [
                        Padding(
  ...
  Widget dealOfDay() {
    return Column(
      children: [
        ...
        Container(
          padding: const EdgeInsets.only(left: 15.0, top: 5.0, bottom: 40.0),
          child: Text(
            'See all deals',
            style: TextStyle(
                color: Colors.cyan[800], overflow: TextOverflow.ellipsis),
          ),
        )
      ],
    );
  ...
  Widget midImage(){
    return Row(
      children: [
        Image.network('https://m.media-amazon.com/images/I/814ibUG4KsS._SL1500_.jpg',
        fit: BoxFit.cover,
        height: 140,
        width: 140,),
        Column(
                ...
                return Column(
                  children: [
                    SizedBox(
                      height: 120.0,
                      child: Image.network(
                          itemLists[index].toppicktoexploreImage
                      ),
                    ),
                    Container(
                      alignment: Alignment.topLeft,
                ...
                return Column(
                  children: [
                    SizedBox(
                      height: 120.0,
                      child: Image.network(
                          itemLists[index].reletedproductImage
                      ),
                    ),
                    Container(
                      alignment: Alignment.topLeft,
